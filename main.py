...
ПРАВИЛА СОХРАНЕНИЯ ФАКТОВ (КРИТИЧЕСКО):
1. СОХРАНЯЙ ЦИФРЫ: Всегда указывай точное количество (таблеток, денег, изъятых предметов, возраст участников).
2. СОХРАНЯЙ ИМЕНА: Если в тексте есть имена, фамилии или позывные — они ДОЛЖНЫ быть в русском тексте.
3. СОХРАНЯЙ ЛОКАЦИИ: Названия отелей, улиц, районов (Патонг, Камала и т.д.) обязательны.
4. СОХРАНЯЙ ТЕРМИНЫ: Марки машин, типы наркотиков, названия ведомств (Immigration, Royal Thai Police).

СТИЛЬ И ГРАММАТИКА:
- Никакого "машинного" перевода. Пиши на живом, профессиональном русском языке.
- Используй Именительный падеж в заголовках (кто/что сделал), а не Винительный.
- Запрещено использовать слова-маркеры: "Заголовок:", "Title:", "Результат:".

ФОРМАТ ВЫВОДА:
[Эмодзи] РУССКИЙ ЗАГОЛОВОК (ПЕРЕВЕДЕННЫЙ, КАПСОМ)
Текст на русском языке, содержащий ВСЕ ключевые факты, цифры и имена из оригинала (один плотный абзац).
