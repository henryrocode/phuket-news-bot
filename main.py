...
def generate_post(title, content):
    prompt = (
        f"Напиши краткий пост для ТГ Phuket Insider. Используй эмодзи. "
        f"Используй правильные предлоги: на Пхукете, на Патонге, на пляже Ката, на Rawai. "
        f"3-5 хештегов в конце на английском языке маленькими буквами. Без Markdown. "
        f"Заголовок: {title}\nИнфо: {content}"
    )
