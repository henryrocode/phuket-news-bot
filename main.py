...
ПРАВИЛА ОФОРМЛЕНИЯ:
1. Сначала русская версия, затем английская.
2. ВАЖНО: Между русской и английской версиями ДОЛЖНА БЫТЬ ОДНА ПУСТАЯ СТРОКА для визуального разделения.
3. Каждая версия начинается с эмодзи и ЗАГОЛОВКА КАПСОМ.
4. Весь текст каждой версии — строго один плотный абзац.
5. Используй предлоги: "на Пхукете", "на Патонге", "на Rawai". Никаких "в Пхукете".
6. В самом конце поста — блок из 6-8 английских хештегов.
7. Не пиши никаких вступлений, пояснений или фраз типа "Вот ваш пост". Только готовый текст.
